...
//             <h3 className="text-center mt-5 sub-heading">Connect With Me</h3>
...
//           <div>
//             <h2 className="heading">Why Our Resume Builder?</h2>

//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
//               {features.map((feature, index) => (
//                 <div key={index} className="card">
//                   <h3 className="sub-heading mb-3">{feature}</h3>
...
//           <div>
//             <h2 className="heading">What Our Users Are Saying</h2>
        ...
        <div className="w-full py-10 md:pt-16 md:pb-6">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
              {features.map((feature, index) => (
                <div key={index} className="card">
                  <h3 className="sub-heading mb-3">{feature.title}</h3>
